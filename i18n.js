...
const I18N = (() => {
  ...
  const ui = {
    nl: {
      ...
      mapSub: 'Van Diepenbeek tot Hooglede — en te voet, per fiets en op Duitse camions weer naar huis. Achtergrond: topografische kaart van het NGI uit 1939 (wegen van toen).',
    ...
    fr: {
      ...
      mapSub: 'De Diepenbeek à Hooglede — puis à pied, à vélo et sur des camions allemands, le chemin du retour. Fond de carte : carte topographique de l\'IGN de 1939 (réseau routier d\'alors).',
    ...
    en: {
      ...
      mapSub: 'From Diepenbeek to Hooglede — and home again on foot, by bicycle and on German lorries. Basemap: NGI topographic map of 1939 (roads as they were then).',
