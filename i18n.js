...
const I18N = (() => {
  ...
  const ui = {
    nl: {
      ...
      mapSub: 'Van Diepenbeek tot Hooglede — en te voet, per fiets en op Duitse camions weer naar huis.',
    ...
    fr: {
      ...
      mapSub: 'De Diepenbeek à Hooglede — puis à pied, à vélo et sur des camions allemands, le chemin du retour.',
    ...
    en: {
      ...
      mapSub: 'From Diepenbeek to Hooglede — and home again on foot, by bicycle and on German lorries.',
